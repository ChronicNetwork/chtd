...
moniker = os.environ.get('CHTD_MONIKER', 'chronic-node')
...
sign_height = int(os.environ.get('DOUBLE_SIGN_CHECK_HEIGHT', '0'))
...
data['p2p']['addr_book_strict'] = addr_book_strict
data['p2p']['pex'] = pex_enable
data['consensus']['double_sign_check_height'] = sign_height
