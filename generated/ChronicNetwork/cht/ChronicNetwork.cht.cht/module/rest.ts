...
export interface ChtCodeInfoResponse {
  ...
  /** AccessConfig access control type. */
  instantiate_permission?: ChtAccessConfig;
}
...
export interface ChtQueryCodesResponse {
  code_infos?: ChtCodeInfoResponse[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cosmwasm/cht/v1/code/{code_id}/contracts
   */
  queryContractsByCode = (
    ...
    this.request<ChtQueryContractsByCodeResponse, RpcStatus>({
      path: `/cosmwasm/cht/v1/code/${code_id}/contracts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmwasm/cht/v1/contract/{address}/raw/{query_data}
   */
  queryRawContractState = (address: string, query_data: string, params: RequestParams = {}) =>
    this.request<ChtQueryRawContractStateResponse, RpcStatus>({
      path: `/cosmwasm/cht/v1/contract/${address}/raw/${query_data}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cosmwasm/cht/v1/contract/{address}/smart/{query_data}
   */
  querySmartContractState = (address: string, query_data: string, params: RequestParams = {}) =>
    this.request<ChtQuerySmartContractStateResponse, RpcStatus>({
      path: `/cosmwasm/cht/v1/contract/${address}/smart/${query_data}`,
      method: "GET",
      format: "json",
      ...params,
    });
